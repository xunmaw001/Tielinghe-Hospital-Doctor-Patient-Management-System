...
public class JianyihezhuyishixiangController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JianyihezhuyishixiangEntity jianyihezhuyishixiang, 
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JianyihezhuyishixiangEntity jianyihezhuyishixiang, HttpServletRequest request){
        EntityWrapper<JianyihezhuyishixiangEntity> ew = new EntityWrapper<JianyihezhuyishixiangEntity>();
		PageUtils page = jianyihezhuyishixiangService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jianyihezhuyishixiang), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JianyihezhuyishixiangEntity> wrapper = new EntityWrapper<JianyihezhuyishixiangEntity>();
		if(map.get("remindstart")!=null) {

<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发药" prop="fayao">
          <el-input v-model="ruleForm.fayao" 
              placeholder="发药" clearable  :readonly="ro.fayao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发药" prop="fayao">
              <el-input v-model="ruleForm.fayao" 
                placeholder="发药" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退药" prop="tuiyao">
          <el-input v-model="ruleForm.tuiyao" 
              placeholder="退药" clearable  :readonly="ro.tuiyao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="退药" prop="tuiyao">
              <el-input v-model="ruleForm.tuiyao" 
                placeholder="退药" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='fayao'){
            this.ruleForm.fayao = obj[o];
	    this.ro.fayao = true;
            continue;
          }
	            	            if(o=='tuiyao'){
            this.ruleForm.tuiyao = obj[o];
	    this.ro.tuiyao = true;
            continue;
          }
	                    }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yaofangguanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yaofangguanliCrossAddOrUpdateFlag = false;
                  this.parent.search();

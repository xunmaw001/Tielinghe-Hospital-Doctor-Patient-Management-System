<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体格检查" prop="tigejiancha">
          <el-input v-model="ruleForm.tigejiancha" 
              placeholder="体格检查" clearable  :readonly="ro.tigejiancha"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体格检查" prop="tigejiancha">
              <el-input v-model="ruleForm.tigejiancha" 
                placeholder="体格检查" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="辅助检查" prop="fuzhujiancha">
          <el-input v-model="ruleForm.fuzhujiancha" 
              placeholder="辅助检查" clearable  :readonly="ro.fuzhujiancha"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="辅助检查" prop="fuzhujiancha">
              <el-input v-model="ruleForm.fuzhujiancha" 
                placeholder="辅助检查" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jianchajijieguo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jianchajijieguoCrossAddOrUpdateFlag = false;
                  this.parent.search();

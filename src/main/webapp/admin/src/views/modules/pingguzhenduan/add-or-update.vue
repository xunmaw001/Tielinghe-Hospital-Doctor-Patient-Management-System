<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="西医诊断" prop="xiyizhenduan">
          <el-input v-model="ruleForm.xiyizhenduan" 
              placeholder="西医诊断" clearable  :readonly="ro.xiyizhenduan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="西医诊断" prop="xiyizhenduan">
              <el-input v-model="ruleForm.xiyizhenduan" 
                placeholder="西医诊断" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="中医诊断" prop="zhongyizhenduan">
          <el-input v-model="ruleForm.zhongyizhenduan" 
              placeholder="中医诊断" clearable  :readonly="ro.zhongyizhenduan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="中医诊断" prop="zhongyizhenduan">
              <el-input v-model="ruleForm.zhongyizhenduan" 
                placeholder="中医诊断" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='xiyizhenduan'){
            this.ruleForm.xiyizhenduan = obj[o];
	    this.ro.xiyizhenduan = true;
            continue;
          }
	            	            if(o=='zhongyizhenduan'){
            this.ruleForm.zhongyizhenduan = obj[o];
	    this.ro.zhongyizhenduan = true;
            continue;
          }
	                    }
                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `pingguzhenduan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.pingguzhenduanCrossAddOrUpdateFlag = false;
                  this.parent.search();

<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检查建议" prop="jianchajianyi">
          <el-input v-model="ruleForm.jianchajianyi" 
              placeholder="检查建议" clearable  :readonly="ro.jianchajianyi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="检查建议" prop="jianchajianyi">
              <el-input v-model="ruleForm.jianchajianyi" 
                placeholder="检查建议" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="注意事项" prop="zhuyishixiang">
              <el-input v-model="ruleForm.zhuyishixiang" 
                placeholder="注意事项" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="处理意见" prop="chuliyijian">
          <el-input v-model="ruleForm.chuliyijian" 
              placeholder="处理意见" clearable  :readonly="ro.chuliyijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="处理意见" prop="chuliyijian">
              <el-input v-model="ruleForm.chuliyijian" 
                placeholder="处理意见" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='jianchajianyi'){
            this.ruleForm.jianchajianyi = obj[o];
	    this.ro.jianchajianyi = true;
            continue;
          }
	            	            if(o=='zhuyishixiang'){
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                        ...
                                        // 多级联动参数
                                                    info(id) {
      this.$http({
        url: `jianyihezhuyishixiang/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jianyihezhuyishixiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jianyihezhuyishixiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
